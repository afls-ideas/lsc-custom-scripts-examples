 ...
 *
 * Related objects: ProductDisbursement, ProductItem, Product2, FormularyProduct__c (custom)
...
async function formularyStatusWarning(contextData) {
    try {
        ...
        // Check if account is an HCO (formulary only applies to institutions)
        ...
        // Get Product2 IDs from sampled ProductItems
        var productItemIds = [];
        ...
        // Check formulary for each product at this HCO
